...
\usepackage{scrhack}\usepackage{mhotext}\usepackage{geometry, graphicx, adjustbox, wrapfig, mathtools, booktabs, siunitx, setspace, subcaption, booktabs,multicol,dirtree,notoccite,xcolor,pifont,float}\usepackage[T1]{fontenc}\usepackage[UKenglish]{babel}\usepackage{gentium}
...
\chapter{Annex 3 - Bibliography read}
